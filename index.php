...
<html>
	<head>
        <title>Boi Na Braza  |  Brazilian Steakhouse</title>
	...
	<body>
        ...
        <div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1 style="font-weight: normal; font-size: 13px;">Powered By <a href="http://mobilegrows.com/" rel="external" style="text-decoration: none;">MobileGrows</a> | <a href="http://www.boinabraza.com/" rel="external" style="text-decoration: none;">  Desktop Site</a></h1>
        </div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-home ui-btn-icon-left font_family" href="#page2" data-transition="<?php echo $transitionefect ?>">Home</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left font_family" href="#page2" data-transition="<?php echo $transitionefect ?>">Our Story</a>
                  </div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left font_family" href="#page2" data-transition="<?php echo $transitionefect ?>">Menu</a>
                  </div>
              </div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left font_family" href="#page2" data-transition="<?php echo $transitionefect ?>">Events & Weddings</a>
					</div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left font_family" href="#page2" data-transition="<?php echo $transitionefect ?>">Gift Cards</a>
                  </div>
              </div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-mail ui-btn-icon-left font_family" href="#contactform" data-transition="<?php echo $transitionefect ?>">Contact</a></div>
				</div>				   
		  </div>
			...
			<div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							<li><a href="#page1" data-transition="<?php echo $transitionefec ?>">Home</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefec ?>">Our Story</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefec ?>">Menu</a></li>
                            <li><a href="#page2" data-transition="<?php echo $transitionefec ?>">Events & Weddings</a></li>
                            <li><a href="#page2" data-transition="<?php echo $transitionefec ?>">Gift Cards</a></li>
							<li><a href="#contactform" data-transition="<?php echo $transitionefec ?>">Contact us</a></li>
						</ul>
					</section>
                    <p class="font_family p_style">This is only a <b>preview</b> version of your Mobile Website.<br>
